...
def print_numbers_times_2(numbers_list):
	for number in numbers_list:  # O(n). Va ejecutarse n cantidad de veces de acuerdo a su entrada. Acá no sabemps cual es su entrada.
		print(number * 2) # O(1)
...
def print_10_or_less_elements(list_to_print):
	...
	for index in range(min(list_len, 10)):# O(1). sabemos que no ejecutará más de 11 veces.
